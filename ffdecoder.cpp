...
int FFDecoder::open()
{
    ...
    if (this->decodeVideo) {
        ...
        videoCodecContext->pix_fmt      = this->videoParam.pixelFmt;
        ...
        this->videoBufferSize  = avpicture_get_size(this->videoParam.pixelFmt, this->videoParam.width, this->videoParam.height);
        this->videoFrameSize   = 0;
...
int FFDecoder::decodeVideoFrame(AVPacket &avpkt)
{
    ...
    if (gotPicture != 0) {
        ...
        avpicture_layout((AVPicture*)&videoFrame, this->videoParam.pixelFmt, this->videoParam.width, this->videoParam.height, this->videoFrameBuffer, this->videoBufferSize);
